...
public class AddressService extends Service {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            switch (state) {
                case TelephonyManager.CALL_STATE_IDLE:
                    //空现状态，没有任何活动（移除吐司）
                    Log.d(TAG, "onCallStateChanged: 挂断电话，空闲状态");
                    //挂断电话的时候窗体需要移除吐司
                ...
                case TelephonyManager.CALL_STATE_OFFHOOK:
                    //摘机状态，至少有个电话活动，该活动或是拨打电话（dialing）或是通话
                    break;
    ...
    public void showToast(String incomingNumber) {
        ...
        //在响铃的时候显示吐司，和电话类型一致
        params.type = WindowManager.LayoutParams.TYPE_TOAST; //改成TYPE_TOAST不需要申请权限
        ...
        //在窗体上挂一个view（权限）改成TYPE_TOAST不需要申请权限

        mWM.addView(mViewToast, params);
//        mViewToast.requestLayout();
        //获取到了来电号码以后，需要做来电号码查询
        query(incomingNumber);
        Log.d(TAG, "showToast: 电话号码" + incomingNumber);
    }
