...
public class AntiVirusActivity extends AppCompatActivity {
    ...
    private LinearLayout ll_aad_text;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SCANING :
                    ...
                    ll_aad_text.addView(textView, 0);
                    break;
                case SCAN_FINISH:
    ...
    private void checkVirus() {
        new Thread(){
            ...
            public void run() {
                ...
                // PackageManager.GET_UNINSTALLED_PACKAGES 卸载完的应用，残余的文件
                List<PackageInfo> packageInfoList = pm.getInstalledPackages(PackageManager.GET_SIGNATURES + PackageManager.MATCH_UNINSTALLED_PACKAGES);
                // 创建记录病毒的集合
                ...
                for (PackageInfo packageInfo : packageInfoList) {
                    ...
                    Log.d(TAG, "应用名称：" + packageInfo.applicationInfo.loadLabel(pm).toString() +"md5:"+ encoder);
    ...
    private void initUI() {
        ...
        ll_aad_text = (LinearLayout) findViewById(R.id.ll_add_text);
    }
}
