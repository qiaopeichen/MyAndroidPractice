...
public class AppManagerActivity extends AppCompatActivity implements View.OnClickListener{
    private List<com.itheima.mobilesafe74.db.domain.AppInfo> mAppInfoList;
    ...
    private void initList() {
        ...
        lv_app_list.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                ...
                // firstVisibleItem第一个可见条目的索引值
                // visibleIemCount当前一个屏幕的可见条目书
                // 总共条目数
    ...
    private void showPopupWindow(View view) {
        ...
        mPopupWindow.setBackgroundDrawable(getResources().getDrawable(R.drawable.call_locate_blue));
        // 3.指定窗体位置
    ...
    private void initTitle() {
        ...
        //3.获取以上两个路径下文件夹的可用大小
        Formatter.formatFileSize(this, getAvailSpace(path));
